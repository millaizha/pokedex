...
function SearchFilterSort({ onApplyFilters }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 ">
      ...
      <div className="mb-4">
        <label htmlFor="search" className="block text-xl font-medium text-gray-700 mb-1">
      ...
      <div className="mb-4">
  <h3 className="text-xl font-medium text-gray-700 mb-1">Filter by Type</h3>
  <div className="flex flex-wrap gap-2">
    {POKEMON_TYPES.map(type => (
      ...
      <div className="mb-4">
        <h3 className="text-xl font-medium text-gray-700 mb-1">Filter by Generation</h3>
        <div className="flex flex-wrap gap-2">
          {GENERATIONS.map(gen => (
            <button
              key={gen}
      ...
      <div className="mb-4">
        <h3 className="text-xl font-medium text-gray-700 mb-1">Filter by Game</h3>
        <select
        ...
        {selectedGames.length > 0 && (
          <div className="mt-2 flex flex-wrap gap-2">
            {selectedGames.map(game => (
              <div
                key={game}
                className="bg-blue-500 text-white px-2 py-1 text-lg rounded-full flex items-center"
              >
                {game.replace(/-/g, ' ')}
                <button
                  onClick={() => handleGameSelect(game)}
                  className="ml-1 text-white hover:text-red-200 bg-blue-500"
                >
                  ×
                </button>
              </div>
